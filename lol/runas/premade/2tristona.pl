...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":18,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"tristona","order":1,"primaryStyleId":8100,"selectedPerkIds":[9923,8143,8138,8135,9111,9104,5005,5008,5003],"subStyleId":8000}';
