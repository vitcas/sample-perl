...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":666,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"sexo","order":1,"primaryStyleId":8000,"selectedPerkIds":[8010,9111,9104,8299,8444,8242,5008,5008,5001],"subStyleId":8400}';
