...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":1,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"aery","order":1,"primaryStyleId":8200,"selectedPerkIds":[8214,8226,8210,8237,8126,8106,5008,5008,5001],"subStyleId":8100}';
