...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":81,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"colheita","order":1,"primaryStyleId":8100,"selectedPerkIds":[8128,8143,8138,8106,8226,8210,5007,5008,5003],"subStyleId":8200}';
