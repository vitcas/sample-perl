...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":53,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"trovao","order":1,"primaryStyleId":8100,"selectedPerkIds":[8112,8126,8138,8106,8226,8210,5007,5008,5003],"subStyleId":8200}';
