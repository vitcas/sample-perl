...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":20,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"predador","order":1,"primaryStyleId":8100,"selectedPerkIds":[8124,8126,8138,8105,8275,8234,5008,5008,5003],"subStyleId":8200}';
