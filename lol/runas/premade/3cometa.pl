...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":22,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"cometa","order":1,"primaryStyleId":8200,"selectedPerkIds":[8229,8226,8210,8237,8139,8106,5007,5008,5003],"subStyleId":8100}';
