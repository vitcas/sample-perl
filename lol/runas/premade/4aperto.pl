...
my ($auth,$port) = @{auth()};
my $token = clean($auth);
my $runepage ='{"autoModifiedSelections":[],"current":true,"id":57,"isActive":false,"isDeletable":true,"isEditable":true,"isValid":true,"lastModified":1628301854132,"name":"aperto","order":1,"primaryStyleId":8400,"selectedPerkIds":[8437,8446,8429,8451,8210,8237,5007,5008,5002],"subStyleId":8200}';
